...
{
MaletaDetector::MaletaDetector(const std::string& name , const BT::NodeConfiguration & config):
...
void MaletaDetector::messageCallback(const std_msgs::String::ConstPtr& msg)
{
  feedBack = msg->data;
  // std::cout << msg->data;
}

void MaletaDetector::halt()
{
  ROS_INFO("Seguir halt");
}

BT::NodeStatus MaletaDetector::tick()
{
  // espero un poco
  if (a < 10 )
  {
